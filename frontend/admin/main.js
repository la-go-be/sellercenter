...
},{"../bower_components/angular-ui/build/angular-ui.min":18,"../bower_components/angular/angular.min":19,"./modules/(main-app)/":5,"./modules/auth/":9,"./modules/modules":11,"./modules/shop/":16,"angular-ui-bootstrap/":21,"angular-ui-router":23,"angular-ui-router-styles/ui-router-styles":22}],2:[function(require,module,exports){
"use strict";
...
var mainConstant = exports.mainConstant = {
    PATH: {
        APIS: "/apis"
    }
};
...
var _constant = require("./constant.main");

var _config = require("./config.main");

var _controller = require("./controller.main");

angular.module("MainApp").constant("MAIN_CONFIG", _constant.mainConstant).config(_config.mainConfig).controller("MainController", _controller.MainController);

},{"./config.main":2,"./constant.main":3,"./controller.main":4}],6:[function(require,module,exports){
"use strict";
...
var AuthController = exports.AuthController = function () {
    AuthController.$inject = ["$window", "$location", "authService"];
    function AuthController($window, $location, authService) {
        "ngInject";
    ...
    _createClass(AuthController, [{
        ...
        value: function signin() {
            ...
            this._authService.signin(this.user).then(function (data) {
                _this._$window.localStorage.user = JSON.stringify(data);
                _this._$location.path('/shop');
            }, function (error) {
                _this.notifyError.signin = true;
                _this.user.password = "";
            });
        }
    }, {
...
var _config = require("./config.auth");

var _controller = require("./controller.auth");

var _service = require("./service.auth");

var _directive = require("./directive.auth-page");

angular.module("Auth").config(_config.authConfig).controller("AuthController", _controller.AuthController).factory("authService", _service.authService).directive("authPage", _directive.authPage);

},{"./config.auth":6,"./controller.auth":7,"./directive.auth-page":8,"./service.auth":10}],10:[function(require,module,exports){
"use strict";
...
function authService($http, $q, MAIN_CONFIG) {
    return {
        signin: signin
    };
...
angular.module('MainApp', ['uiRouterStyles', 'ui.bootstrap', 'ui.filters', 'Auth', 'Shop']);
...
var ShopController = exports.ShopController = function () {
    ShopController.$inject = ["$window", "$location", "shopService"];
    function ShopController($window, $location, shopService) {
        "ngInject";
    ...
    _createClass(ShopController, [{
        ...
        value: function getItems() {
            ...
            this._shopService.getItems().then(function (data) {
                _this.items = data;
            });
        }
    }, {
        key: "getDetail",
        value: function getDetail(shopID) {
            var _this2 = this;

            this.initDetail();

            this._shopService.getDetail(shopID).then(function (data) {
                _this2.info = data;

                if (data.store.individual.document.citizenCard) {
                    _this2.getStoreDocumentURL('individual', 'citizenCard');
                }
                if (data.store.individual.document.homeRegister) {
                    _this2.getStoreDocumentURL('individual', 'homeRegister');
                }
                if (data.store.company.document.companyCertificate) {
                    _this2.getStoreDocumentURL('company', 'companyCertificate');
                }
                if (data.store.company.document.tradeRegister) {
                    _this2.getStoreDocumentURL('company', 'tradeRegister');
                }
            });
        }
    }, {
        ...
        value: function getStoreDocumentURL(businessType, documentName) {
            ...
            this._shopService.getAWSS3URL(this.info.store[businessType].document[documentName]).then(function (data) {
                _this3.image[businessType][documentName] = data.awsS3URL;
            }, function (error) {
                alert(error.message);
            });
        }
...
var _config = require("./config.shop");

var _controller = require("./controller.shop");

var _service = require("./service.shop");

var _directive = require("./directive.shop-page");

var _directive2 = require("./directive.shop-item");

angular.module("Shop").config(_config.shopConfig).controller("ShopController", _controller.ShopController).factory("shopService", _service.shopService).directive("shopPage", _directive.shopPage).directive("shopItem", _directive2.shopItem);

},{"./config.shop":12,"./controller.shop":13,"./directive.shop-item":14,"./directive.shop-page":15,"./service.shop":17}],17:[function(require,module,exports){
"use strict";
...
function shopService($http, MAIN_CONFIG) {
    return {
        getItems: getItems,
        getDetail: getDetail,
    ...
    function getItems() {
        return $http.get(MAIN_CONFIG.PATH.APIS + "/admin/shops/list").then(function (respond) {
            return respond.data;
        }, function (reason) {
            return reason.data;
        });
    ...
    function getDetail(shopID) {
        return $http.get(MAIN_CONFIG.PATH.APIS + "/admin/shops/detail/" + shopID).then(function (respond) {
            return respond.data;
        }, function (reason) {
            return reason.data;
        });
    ...
    function getAWSS3URL(awsS3Key) {
        return $http.get(MAIN_CONFIG.PATH.APIS + "/awsS3/url?awsS3Key=" + awsS3Key).then(function (respond) {
            return respond.data;
        }, function (reason) {
            return reason.data;
        });
